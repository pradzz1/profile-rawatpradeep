    ...
    <section className="relative  2xl:py-40 bg-gray-800">
       ...
       <div className="relative container px-4 mx-auto minH" >
         <div className="text-center mb-20">
           <h2 className="mt-10 text-5xl font-bold font-heading text-white">Contact</h2>
         </div>
         <div className="max-w-4xl mx-auto">
           <div className="flex flex-wrap -mx-4 mb-20">
             <div className="w-full lg:w-1/2 px-4 mb-4 lg:mb-0">
               <div className="bg-gray-600 rounded-b-lg">
                 <img className="h-64 w-full rounded-lg object-cover" src="https://ik.imagekit.io/pradeeprawat/image3_zrG2ER-FpT.jpeg?ik-sdk-version=javascript-1.4.3&updatedAt=1644153360697" alt="" />
             ...
             <div className="w-full lg:w-1/2 px-4">
               <div className="py-6 px-8 mb-4 bg-gray-600 rounded-lg">
                 <div className="flex items-center">
                   ...
                   <p className="text-lg font-bold text-white">+919886188822</p>
                 </div>
               </div>
               <div className="py-6 px-8 mb-10 bg-gray-600 rounded-lg">
                 <div className="flex items-center">
                   ...
                   <p className="text-lg font-bold text-white">pradzz.rawat6@gmail.com</p>
                 </div>
               </div>
                 ...
                 <div className="flex">
                   ...
                   <div>
                     <div className="pb-4 pr-16 mb-6 border-b border-gray-500">
                       <p className="text-lg font-bold text-white">Whitefield</p>
                       <p className="text-lg font-bold text-white">Bangalore, KA</p>
                     </div>
                   </div>
                 </div>
               </div>
